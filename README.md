...
- Додаткові графіки з окремими кольорами й переглядом у календарі та модалці дня
...
- Екран `Графіки` дозволяє додавати додаткові графіки, вмикати або ховати їх і редагувати окремо
