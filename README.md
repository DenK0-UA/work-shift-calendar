...
3. відкриваєте `🎨 Вигляд`, копіюєте або звіряєте `ID пристрою`
4. додаєте цей `ID пристрою` у allowlist `beta/access.json`
5. тільки після цього на вашому пристрої з’являється блок перемикання на `Beta`
6. після апруву переносите реліз у `stable`
7. усі інші пристрої отримують звичне сповіщення про нову версію
